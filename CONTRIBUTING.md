...
```
git clone https://github.com/contributor/CoCreate-progressbar.git
...
```
* [#123](https://github.com/CoCreate-app/CoCreate-progressbar/pull/123): Reticulated splines - [@contributor](https://github.com/contributor).
```
